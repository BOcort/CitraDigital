...
rle = fscanf(fileID, '%d'); % Membaca data RLE dari file
fclose(fileID);
...
% Dekompresi (RLE decoding)
Decompressed = zeros(r, c); % Matriks untuk hasil dekompresi
index = 1; % Indeks data RLE
kali = 0; % Hitung jumlah kemunculan piksel
...
imshow(uint8(Decompressed)); % Konversi ke uint8 sebelum ditampilkan
